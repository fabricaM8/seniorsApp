 ...
 */
public class PhysicalActivitiesDAL extends DbCRUD<Medication> {

    public static final String TABLE_NAME = "Physical";

    private static PhysicalActivitiesDAL _instance;

    private PhysicalActivitiesDAL(Context context) {
        super(context);
    }

    public static synchronized PhysicalActivitiesDAL getInstance(Context context) {
        if (_instance == null) {
            _instance = new PhysicalActivitiesDAL(context);
        }
