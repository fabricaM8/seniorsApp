...
public class LocationActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setHeaderTitle(getString(R.string.title_activity_location));
        ...
        // Build the google location client
        buildGoogleApiClient();
    }

    // Builds the google location client
    ...
    /**
     * When invoked, sets the current address.
    ...
    /**
     * When invoked, starts automatica updates
    ...
    /**
     * When invoked, stops the update location service
        ...
        if (connectionResult.hasResolution()) {
            try {
                ...
                */
                ...
                // Log the error
                Log.e(LocationUtils.APPTAG, e.getMessage());
                e.printStackTrace();
            }
        } else {
    ...
    private void startPeriodicUpdates() {
        LocationServices.FusedLocationApi.requestLocationUpdates(
                mLocationClient, mLocationRequest, (LocationListener) this);
    ...
    protected class GetAddressTask extends AsyncTask<Location, Void, String> {
        ...
        protected String doInBackground(Location... params) {
            ...
            } catch (IllegalArgumentException argsex) {
